// <copyright file="Vector3.cs" company="SubC Imaging">
...
namespace SubCTools.DataTypes
{
    ...
    /// Magnitude is now a property Abs(...) now returns magnitude, Recommend: use magnitude
    /// property instead Equality opeartions now have a tolerance (note that greater and less than
    /// type operations do not) IsUnit methods also have a tolerance Generic IEquatable and
    /// IComparable interfaces implemented IFormattable interface (ToString(format, format provider)
    /// implemented Mixed product function implemented.
    /// </Changes>
    /// <Changes vesion="x">
    /// Square components method was pointing to the square root static method Added comments about
    /// meaning of comparison operations on two vectors Changed references to degrees to radians
    /// Changed the implementation of Angle to help avoid NaN results The Vector3 class is now
    /// immutable, property setters have been removed and mutable methods return a new Vector3
    /// Updated comments to read better under intellisense. Added Projection, Rejection and
    /// Reflection operations Split up operations into regions Added scale operations which used to
    /// be accessable through the magnitude mutable property Changed the Equals(object) method to
    /// use Equals(Vector3) Added component rounding operations Added rotate arround x, y or z (with
    /// or without axis offsets) Added Equals overloads with an absolute tolerace parameters Added
    /// IsUnitVector overloads with absolute tolerance parameters Added IsPerpendicular overloads
    /// with absolute toleerance parameters Added CompareTo overloads with absolut tolerance
    /// parameters Fixed an infinity issue in the Vector3.CompareTo method Unit testing proved that
    /// NaN == NaN is not the same as Nan.Equals(NaN) - Altered .Equals method to be consistent with
    /// the .Net framework Added IsNaN methods Added NormalizeOrDefault method Added special cases
    /// where we can normalize vectors with infinite components. IsPerpendicular now uses
    /// NormalizeOrDefault to account for special cases of infinty. Renamed Double.AlmostEquals
    /// methods to AlmostEqualsWithAbsTolerance and EqualToUps.
    /// </Changes>
    /// <remarks>
    /// IComparable has been implemened on the Vector3 type however comparing two vectors has no
    /// meaning, we are comparing the magnitude of two vectors for convinience. It would be more
    /// accurate to compare the magnitudes explicitly.
    /// </remarks>
    ...
    {
        /// <summary>
        /// The smallest positive (non-zero) vector possible (based on the double precision floating
        /// point structure).
        /// </summary>
        ...
        /// <summary>
        /// Exception message additional information text, used when adding length (number of
        /// components in an array) information of the given argument into an error message.
        /// </summary>
        private const string ARGUMENT_LENGTH = "The argument provided has a length of ";

        /// <summary>
        /// Exception message additional information text, used when adding type information of the
        /// given argument into an error message.
        /// </summary>
        private const string ARGUMENT_TYPE = "The argument provided is a type of ";

        /// <summary>
        /// Exception message additional information text, used when adding value information of the
        /// given argument into an error message.
        /// </summary>
        private const string ARGUMENT_VALUE = "The argument provided has a value of ";

        /// <summary>
        /// Exception message descriptive text, used when interpolation is attempted with a control
        /// parameter not between 0 and 1.
        /// </summary>
        ...
        /// <summary>
        /// Exception message descriptive text Used when attempting to set a vectors magnitude to a
        /// negative value.
        /// </summary>
        private const string NEGATIVE_MAGNITUDE = "The magnitude of a Vector3 must be a positive value, (i.e. greater than 0)";

        /// <summary>
        /// Exception message descriptive text, used when attempting to compare a Vector3 to an
        /// object which is not a type of Vector3.
        /// </summary>
        private const string NON_VECTOR_COMPARISON = "Cannot compare a Vector3 to a non-Vector3";

        /// <summary>
        /// Exception message descriptive text, used when an attempt is made to normalize a vector
        /// with magnitude 0.
        /// </summary>
        ...
        /// <summary>
        /// Exception message descriptive text, used when an attemp is made to normalize a vector
        /// with magnitude NaN.
        /// </summary>
        private const string NORMALIZE_NaN = "Cannot normalize a vector when it's magnitude is NaN";

        /// <summary>
        /// Exception message descriptive text, used when attempting to set a vectors magnitude
        /// where the vector represents the origin.
        /// </summary>
        ...
        /// <summary>
        /// Exception message descriptive text, used for a failure for an array argument to have
        /// three components when three are needed .
        /// </summary>
        ...
        /// <implementation>
        /// Uses the mutator properties for the Vector3 components to allow verification of input
        /// (if implemented) This results in the need for pre-initialisation initialisation of the
        /// Vector3 components to 0 Due to the necessity for struct's variables to be set in the
        /// constructor before moving control.
        /// </implementation>
        ...
        /// <implementation>Uses the VectorArray property to avoid validation code duplication.</implementation>
        ...
        /// </summary>
        [XmlIgnore]
        public double[] Array => new[] { this.x, this.y, this.z };
        ...
        /// <summary>
        /// Gets or sets get the x component of the Vector3.
        /// </summary>
        public double X
        {
            get => this.x;
        ...
        /// <summary>
        /// Gets or sets get the y component of the Vector3.
        /// </summary>
        public double Y
        {
            get => this.y;
        ...
        /// <summary>
        /// Gets or sets get the z component of the Vector3.
        /// </summary>
        public double Z
        {
            get => this.z;
        ...
        /// <summary>
        /// Find the absolute value of a vector. Find the magnitude of a vector.
        /// </summary>
        /// <returns>A Vector3 representing the absolute values of the vector.</returns>
        /// <implementation>An alternative interface to the magnitude property.</implementation>
        ...
        /// <Acknowledgement>
        /// Wrapping this calculation in Math.Min(...) was suggested by Dennis E. Cox.
        /// </Acknowledgement>
        ...
        /// <summary>
        /// Determine the cross product of two Vectors. Determine the vector product. Determine the
        /// normal vector (Vector3 90° to the plane).
        /// </summary>
        ...
        /// <implementation>Cross products are non commutable.</implementation>
        ...
        /// <summary>
        /// Find the distance between two vectors. Apply Pythagoras theorem on two vectors.
        /// </summary>
        ...
        /// <param name="control">
        /// The interpolated point between the two vectors to retrieve (fraction between 0 and 1),
        /// or an extrapolated point if allowed.
        /// </param>
        /// <param name="allowExtrapolation">
        /// True if the control may represent a point not on the vertex between v1 and v2.
        /// </param>
        /// <returns>
        /// The value at an arbitrary distance (interpolation) between two vectors or an
        /// extrapolated point on the extended virtex.
        /// </returns>
        ...
        /// <implementation>
        /// <see cref="Interpolate(Vector3, Vector3, double, bool)" /> Uses the
        /// Interpolate(Vector3,Vector3,double,bool) method to avoid code duplication.
        /// </implementation>
        /// <exception cref="System.ArgumentOutOfRangeException">
        ...
        /// <summary>
        /// Checks if a face normal vector represents back face. Checks if a face is visible, given
        /// the line of sight.
        /// </summary>
        ...
        /// <implementation>Uses the DotProduct function in the check to avoid code duplication.</implementation>
        ...
        /// <summary>
        /// Checks if two vectors are perpendicular within a tolerance. Checks if two vectors are
        /// orthogonal within a tolerance. Checks if one vector is the normal of the other within a tolerance.
        /// </summary>
        ...
        /// The absolute difference tolerance to use when comparing the dot product to 0.
        /// </param>
        /// <returns>Truth if the two vectors are perpendicular within a tolerance.</returns>
        /// <implementation>
        /// Uses the <see cref="DotProduct(Vector3)" /> function in the check to avoid code
        /// duplication. Uses the <see cref="NormalizeOrDefault(Vector3)" /> function in the check
        /// to avoid code duplication and to include spcial cased of inifite values. Of the three
        /// flavours of AlmostEquals that have been implemented the absolute value tolerance is the
        /// only one that makes senses when comparing to 0. If we later implement relative and/or
        /// ulp tolerance, this method would not benefit from the overloads.
        /// </implementation>
        /// <remarks>
        /// The tolerance is not used for special case vectors that have only infinite and zero
        /// components. We only consider special cases where the zero components are exactly zero.
        /// </remarks>
        public static bool IsPerpendicular(Vector3 v1, Vector3 v2, double tolerance)
        {
            ...
            // Is perpendicular
            return WithinTolerance(v1.DotProduct(v2), 0, tolerance);
        }

        /// <summary>
        /// Checks if two vectors are perpendicular. Checks if two vectors are orthogonal. Checks if
        /// one vector is the normal of the other.
        /// </summary>
        /// <param name="v1">The vector to be checked for orthogonality.</param>
        /// <param name="v2">The vector to be checked for orthogonality to.</param>
        ...
        /// Uses the <see cref="DotProduct(Vector3)" /> function in the check to avoid code
        /// duplication. Uses the <see cref="NormalizeOrDefault(Vector3)" /> function in the check
        /// to avoid code duplication and to include spcial cased of inifite values.
        /// </implementation>
        ...
        /// <summary>
        /// Checks if a vector is a unit vector within a tolerance. Checks if the Vector has been
        /// normalized within a tolerance. Checks if a vector has a magnitude of 1 within a tolerance.
        /// </summary>
        ...
        /// <implementation>Uses the <see cref="Magnitude" /> property to avoid code duplication.</implementation>
        public static bool IsUnitVector(Vector3 v1, double tolerance)
        {
            return WithinTolerance(v1.Magnitude, 1, tolerance);
        }

        /// <summary>
        /// Checks if a vector is a unit vector. Checks if the Vector has been normalized. Checks if
        /// a vector has a magnitude of 1.
        /// </summary>
        /// <param name="v1">The vector to be checked for Normalization.</param>
        ...
        /// <Acknowledgement>This code is adapted from Exocortex - Ben Houston.</Acknowledgement>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for
        /// convinience. It would be more accurate to compare the magnitudes explicitly using
        /// Math.Max(v1.Magnitude, v2.Magnitude).
        /// </remarks>
        ...
        /// <param name="v1">The vector to compare.</param>
        /// <param name="v2">The vector to compare with.</param>
        /// <returns>The lesser of the two Vectors (based on magnitude).</returns>
        /// <Acknowledgement>This code is adapted from Exocortex - Ben Houston.</Acknowledgement>
        /// ///
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for
        /// convinience. It would be more accurate to compare the magnitudes explicitly using Math.Min(v1.Magnitude,v2.Magnitude).
        /// </remarks>
        ...
        /// <summary>
        /// Determine the mixed product of three vectors. Determine volume (with sign precision) of
        /// parallelepiped spanned on given vectors. Determine the scalar triple product of three vectors.
        /// </summary>
        ...
        /// <implementation>
        /// Mixed products are non commutable <see cref="CrossProduct(Vector3, Vector3)" /><see
        /// cref="DotProduct(Vector3, Vector3)" />.
        /// </implementation>
        ...
        /// <implementation>
        /// Uses the <see cref="Magnitude" /> property to avoid code duplication. Uses the private
        /// <see cref="NormalizeOrNaN(Vector3)" /> method to avoid code duplication.
        /// </implementation>
        ...
        /// <param name="v1">The vector to be normalized.</param>
        /// <returns>
        /// Vector (0,0,0) if the magnitude is zero, vector (NaN,NaN,NaN) if the magnitude is NaN,
        /// or the normalized vector.
        /// </returns>
        /// <implementation>
        /// Uses the <see cref="Magnitude" /> property to avoid code duplication. Uses the private
        /// <see cref="NormalizeOrNaN(Vector3)" /> method to avoid code duplication.
        ...
        /// <summary>
        /// Negation of a vector. Invert the direction of the Vector3 Make Vector3 negative (-vector).
        /// </summary>
        ...
        /// <summary>
        /// Negative comparator of two Vectors. Are two Vectors different.
        /// </summary>
        ...
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Viñas Livschitz.</Acknowledgement>
        /// <Implementation>
        /// Using the commutative law 'scalar x vector'='vector x scalar'. Thus, this function calls
        /// 'operator*(Vector3 v1, double s2)'. This avoids repetition of code.
        /// </Implementation>
        ...
        /// <summary>
        /// Reinforcement of a vector. Make Vector3 positive (+vector).
        /// </summary>
        /// <param name="v1">Vector3 to be reinforced.</param>
        /// <returns>Reinforced vector.</returns>
        /// <Acknowledgement>This code is adapted from Exocortex - Ben Houston.</Acknowledgement>
        /// <Implementation>
        /// Using the rules of Addition (i.e. '+-x' = '-x' and '++x' = '+x') This function actually
        /// does nothing but return the argument as given.
        /// </Implementation>
        public static Vector3 operator +(Vector3 v1)
        {
            return new Vector3(
        ...
        /// <summary> Compare the magnitude of two vectors (less than). </summary> <param
        /// name="v1">Vector3 to be compared. </param> <param name="v2">Vector3 to be compared
        /// with.</param> <returns>True if v1 less than v2.</returns> <remarks> Comparing two
        /// vectors has no meaning, we are comparing the magnitude of two vectors for convinience.
        /// It would be more accurate to compare the magnitudes explicitly using v1.Magnitude. <
        /// v2.Magnitude. </remarks>
        public static bool operator <(Vector3 v1, Vector3 v2)
        {
            return v1.SumComponentSqrs() < v2.SumComponentSqrs();
        }

        /// <summary> Compare the magnitude of two vectors (less than or equal to). </summary>
        /// <param name="v1">Vector3 to be compared. </param> <param name="v2">Vector3 to be
        /// compared with.</param> <returns>True if v1 less than or equal to v2.</returns> ///
        /// <remarks> Comparing two vectors has no meaning, we are comparing the magnitude of two
        /// vectors for convinience. It would be more accurate to compare the magnitudes explicitly
        /// using v1.Magnitude. <= v2.Magnitude. </remarks>
        public static bool operator <=(Vector3 v1, Vector3 v2)
        {
            return v1.SumComponentSqrs() <= v2.SumComponentSqrs();
        }
        ...
        /// <summary>
        /// Compare two Vectors for equality. Are two Vectors equal.
        /// </summary>
        ...
        /// <summary>
        /// Rotates a vector around the X axis. Change the pitch of a vector.
        /// </summary>
        ...
        /// <summary>
        /// Projects the specified v1 onto the specified v2. The vector resolute of v1 in the
        /// direction of v2.
        /// </summary>
        /// <param name="v1">The vector that will be projected.</param>
        /// <param name="v2">
        /// A nonzero vector that v1 will be projected upon. The direction to project.
        /// </param>
        ...
        /// <param name="v2">
        /// A nonzero vector for which the vector rejection of v1 will be calculated. The direction.
        /// </param>
        ...
        /// <summary>
        /// Rotates a vector around the Z axis. Change the roll of a vector.
        /// </summary>
        /// <param name="v1">The Vector3 to be rotated.</param>
        /// <param name="rad">The angle to rotate the Vector3 around in radians.</param>
        ...
        {
            var x = v1.X;
            var y = (v1.Y * Math.Cos(rad)) - (v1.Z * Math.Sin(rad));
            var z = (v1.Y * Math.Sin(rad)) + (v1.Z * Math.Cos(rad));
        ...
        {
            var x = v1.X;
            var y = (v1.Y * Math.Cos(rad)) - (v1.Z * Math.Sin(rad)) + (yOff * (1 - Math.Cos(rad)) + zOff * Math.Sin(rad));
            var z = (v1.Y * Math.Sin(rad)) + (v1.Z * Math.Cos(rad)) + (zOff * (1 - Math.Cos(rad)) - yOff * Math.Sin(rad));
            return new Vector3(x, y, z);
        }
        ...
        {
            var x = (v1.Z * Math.Sin(rad)) + (v1.X * Math.Cos(rad));
            var y = v1.Y;
            var z = (v1.Z * Math.Cos(rad)) - (v1.X * Math.Sin(rad));
            return new Vector3(x, y, z);
        }
        ...
        {
            var x = (v1.Z * Math.Sin(rad)) + (v1.X * Math.Cos(rad)) + (xOff * (1 - Math.Cos(rad)) - zOff * Math.Sin(rad));
            var y = v1.Y;
            var z = (v1.Z * Math.Cos(rad)) - (v1.X * Math.Sin(rad)) + (zOff * (1 - Math.Cos(rad)) + xOff * Math.Sin(rad));
            return new Vector3(x, y, z);
        }
        ...
        {
            var x = (v1.X * Math.Cos(rad)) - (v1.Y * Math.Sin(rad));
            var y = (v1.X * Math.Sin(rad)) + (v1.Y * Math.Cos(rad));
            var z = v1.Z;
            return new Vector3(x, y, z);
        }
        ...
        {
            var x = (v1.X * Math.Cos(rad)) - (v1.Y * Math.Sin(rad)) + (xOff * (1 - Math.Cos(rad)) + yOff * Math.Sin(rad));
            var y = (v1.X * Math.Sin(rad)) + (v1.Y * Math.Cos(rad)) + (yOff * (1 - Math.Cos(rad)) - xOff * Math.Sin(rad));
            var z = v1.Z;
            return new Vector3(x, y, z);
        }
        ...
        /// and the other odd, then the even number is returned.
        /// </remarks>
        ...
        /// <param name="v1">The vector who's components are to be rounded.</param>
        /// <param name="mode">
        /// An enum to specify how rounding should happen for numbers midway between two other number.
        /// </param>
        /// <returns>The rounded vector.</returns>
        ...
        /// <summary>
        /// Scale a vector. Change the magnitude of a vector.
        /// </summary>
        ...
        /// <summary>
        /// Rotates a vector around the Y axis. Change the yaw of a vector.
        /// </summary>
        /// <param name="v1">The Vector3 to be rotated.</param>
        /// <param name="rad">The angle to rotate the Vector3 around in radians.</param>
        ...
        /// <returns>The angle between two positional Vectors.</returns>
        /// <implementation>
        /// <see cref="Angle(Vector3, Vector3)" /> Uses the Angle(Vector3,Vector3) method to avoid
        /// code duplication.
        /// </implementation>
        ...
        /// </returns>
        /// <implementation>Implemented to fulfil the IComparable interface.</implementation>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for
        /// convinience. It would be more accurate to compare the magnitudes explicitly using v1.Magnitude.CompareTo(v2.Magnitude).
        /// </remarks>
        /// <Acknowledgement>This code is adapted from Exocortex - Ben Houston.</Acknowledgement>
        ...
        /// <summary>
        /// Determine the cross product of this vector and another. Determine the vector product.
        /// Determine the normal vector (Vector3 90° to the plane).
        /// </summary>
        /// <param name="other">The vector to multiply by.</param>
        /// <returns>Vector3 representing the cross product of the two vectors.</returns>
        /// <implementation>
        /// Uses the CrossProduct function to avoid code duplication <see
        /// cref="CrossProduct(Vector3, Vector3)" />.
        /// </implementation>
        ...
        /// <returns>The distance between two Vectors.</returns>
        /// <implementation>
        /// <see cref="Distance(Vector3, Vector3)" /> Overload for Distance method, finds distance
        /// between this Vector3 and another Uses the Distance(Vector3,Vector3) method to avoid code duplication.
        /// </implementation>
        ...
        /// <param name="other">The vector to multiply by.</param>
        /// <returns>Scalar representing the dot product of the two vectors.</returns>
        /// <implementation><see cref="DotProduct(Vector3)" />.</implementation>
        ...
        /// <implementation>
        /// Checks if the object argument is a Vector3 object Uses the equality operator function to
        /// avoid code duplication Required in order to implement comparator operations (i.e. ==, !=).
        /// </implementation>
        ...
        /// <implementation>Uses the equality operator function to avoid code duplication.</implementation>
        /// <remarks>NaN and NaN components will be equal in this method but not in ==, see http://blogs.msdn.com/b/shawnfa/archive/2004/07/19/187792.aspx.</remarks>
        ...
        {
            return
                WithinTolerance(this.X, other.X, tolerance) &&
                WithinTolerance(this.Y, other.Y, tolerance) &&
                WithinTolerance(this.Z, other.Z, tolerance);
        }
        ...
        /// <returns>The value at an arbitrary distance (interpolation) between two vectors.</returns>
        /// <implementation>
        /// <see cref="Interpolate(Vector3, Vector3, double)" /> Overload for Interpolate method,
        /// finds an interpolated value between this Vector3 and another Uses the
        /// Interpolate(Vector3,Vector3,double) method to avoid code duplication.
        /// </implementation>
        ...
        /// <returns>Truth if the vector (as a normal) represents a back face.</returns>
        /// <implementation>
        /// <see cref="Vector3.IsBackFace(Vector3, Vector3)" /> Uses the isBackFace(Vector3,
        /// Vector3) function in the check to avoid code duplication.
        /// </implementation>
        ...
        /// <summary>
        /// Checks if this vector is perpendicular to another. Checks if this vector is orthogonal
        /// to another. Checks if this vector is the Normal of the other.
        /// </summary>
        /// <param name="other">The vector to be checked for orthogonality.</param>
        /// <returns>Truth if the two vectors are perpendicular.</returns>
        /// <implementation>
        /// Uses the <see cref="IsPerpendicualr(Vector3, Vector3)" /> function in the check to avoid
        /// code duplication.
        /// </implementation>
        ...
        /// <summary>
        /// Checks if this vector is perpendicular to another within a tolerance. Checks if this
        /// vector is orthogonal to another within a tolerance. Checks if this vector is the Normal
        /// of the other within a tolerance.
        /// </summary>
        /// <param name="other">The vector to be checked for orthogonality.</param>
        /// <param name="tolerance">
        /// The absolute difference tolerance to use when comparing the dot product to 0.
        ...
        /// <returns>Truth if the two vectors are perpendicular.</returns>
        /// <implementation>
        /// Uses the <see cref="IsPerpendicualr(Vector3, Vector3, double)" /> function in the check
        /// to avoid code duplication. Of the three flavours of AlmostEquals that have been
        /// implemented the absolute value tolerance is the only one that makes senses when
        /// comparing to 0. If we later implement relative and/or ulp tolerance, this method would
        /// not benefit from the overloads.
        /// </implementation>
        ...
        /// <summary>
        /// Checks if the vector a unit vector. Checks if the vector has been normalized. Checks if
        ...
        /// <summary>
        /// Checks if the vector is a unit vector within a tolerance. Checks if the vector has been
        /// normalized within a tolerance. Checks if the vector has a magnitude of 1 within a tolerance.
        /// </summary>
        /// <param name="tolerance">The tolerance to use when comparing the magnitude.</param>
        ...
        /// <returns>The greater of the two Vectors (based on magnitude).</returns>
        /// <implementation>
        /// <see cref="Max(Vector3, Vector3)" /> Uses function Max(Vector3, Vector3) to avoid code duplication.
        /// </implementation>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for
        /// convinience. It would be more accurate to compare the magnitudes explicitly using v1.Magnitude.Max(v2.Magnitude).
        /// </remarks>
        ...
        /// <returns>The lesser of the two Vectors (based on magnitude).</returns>
        /// <implementation>
        /// <see cref="Min(Vector3, Vector3)" /> Uses function Min(Vector3, Vector3) to avoid code duplication.
        /// </implementation>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for
        /// convinience. It would be more accurate to compare the magnitudes explicitly using v1.Magnitude.Min(v2.Magnitude).
        /// </remarks>
        ...
        /// <returns>Scalar representing the mixed product of the three vectors.</returns>
        /// <implementation>
        /// Mixed products are non commutable <see cref="MixedProduct(Vector3, Vector3, Vector3)" />
        ...
        /// <implementation>Uses function Pitch(Vector3, double) to avoid code duplication.</implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z.</remarks>
        ...
        /// <returns>The multiplied Vector3.</returns>
        /// <implementation>
        /// <see cref="PowComponents(Vector3, double)" /> The Components.PowComponents(Vector3,
        /// double) function has been used to prevent code duplication.
        /// </implementation>
        ...
        /// <summary>
        /// Projects the vector onto the specified vector. The vector resolute this vector in a
        /// direction specified by a vector.
        /// </summary>
        /// <param name="direction">
        /// A nonzero vector that the vector will be projected upon. The direction to project.
        /// </param>
        /// <returns>The projected vector.</returns>
        /// <acknowlagement>
        /// Provided by Poggel, Steven Buraje in comments on CodeProject (
        ...
        /// </summary>
        /// <param name="direction">
        /// A nonzero vector for which the vector rejection of this vector will be calculated. The direction.
        /// </param>
        ...
        /// <returns>Vector3 representing the rotation around the Z axis.</returns>
        /// <implementation>
        /// <see cref="Roll(Vector3, double)" /> Uses function Roll(Vector3, double) to avoid code duplication.
        /// </implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z.</remarks>
        ...
        /// <summary>
        /// Scale this vector. Change the magnitude of this vector.
        /// </summary>
        /// <param name="magnitude">The magnitude to be set.</param>
        ...
        /// <returns>The squared Vector3.</returns>
        /// <implementation>
        /// <see cref="SqrtComponents(Vector3)" /> The Components.SqrComponents(Vector3) function
        /// has been used to prevent code duplication.
        /// </implementation>
        ...
        /// <returns>The rooted Vector3.</returns>
        /// <implementation>
        /// <see cref="SqrtComponents(Vector3)" /> The Components.SqrtComponents(Vector3) function
        /// has been used to prevent code duplication.
        /// </implementation>
        ...
        /// <returns>The sum of the Vectors X, Y and Z components.</returns>
        /// <implementation>
        /// <see cref="SumComponents(Vector3)" /> The Components.SumComponents(Vector3) function has
        /// been used to prevent code duplication.
        /// </implementation>
        ...
        /// <returns>The sum of the Vectors X^2, Y^2 and Z^2 components.</returns>
        /// <implementation>
        /// <see cref="SumComponentSqrs(Vector3)" /> The Components.SumComponentSqrs(Vector3)
        /// function has been used to prevent code duplication.
        /// </implementation>
        ...
        /// </summary>
        /// <Implementation>Uses ToString(string, IFormatProvider) to avoid code duplication.</Implementation>
        ...
        /// </summary>
        /// <param name="format">
        /// Formatting string: 'x','y','z' or '' followed by standard numeric format string
        /// characters valid for a double precision floating point.
        /// </param>
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            {
                case 'x':
                    return this.X.ToString(remainder, formatProvider);

                case 'y':
                    return this.Y.ToString(remainder, formatProvider);

                case 'z':
                    return this.Z.ToString(remainder, formatProvider);
        ...
        /// <summary>
        /// Rotates a vector around the Y axis. Change the yaw of the vector.
        /// </summary>
        /// <param name="rad">The angle to rotate the Vector3 around in radians.</param>
        /// <returns>Vector3 representing the rotation around the Y axis.</returns>
        /// <implementation>
        /// <see cref="Yaw(Vector3, double)" /> Uses function Yaw(Vector3, double) to avoid code duplication.
        /// </implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z.</remarks>
        ...
        /// <param name="v1">The vector to be normalized.</param>
        /// <returns>
        /// The normalized vector3 or vector (NaN,NaN,NaN) if the magnitude is 0 or NaN.
        /// </returns>
        /// <implementation>Uses the <see cref="Magnitude" /> property to avoid code duplication.</implementation>
        ...
        /// <summary>
        /// This method is used to normalize special cases of vectors where the components are
        /// infinite and/or zero only. Other vectors will be returned un-normalized.
        /// </summary>
        ...
        private static bool WithinTolerance(double value, double expected, double tolerance)
        {
    ...
    public class NormalizeVectorException : Exception
    {
        ...
        /// cref="T:RP.Math.Exceptions.NormalizeVectorException" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see
        /// cref="T:RP.Math.Exceptions.NormalizeVectorException" /> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see
        /// cref="T:RP.Math.Exceptions.NormalizeVectorException" /> class with a specified error
        ...
        /// <summary>
        /// Initializes a new instance of the <see
        /// cref="T:RP.Math.Exceptions.NormalizeVectorException" /> class with serialized data.
        /// </summary>
        /// <param name="info">
